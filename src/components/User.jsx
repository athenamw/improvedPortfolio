    ...
    <section className={`relative w-full h-screen mx-auto`}>
     <section className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        <section className='flex flex-col justify-center items-center mt-5'>
          ...
          <section className='w-1 sm: h-80 h-40 teal-gradient'/>
        </section>

        <section>
          <h1 className={`${styles.userHeadText}text-white`}>Hi, I'm <span className="text-[#4b95f1]">Athena</span></h1>
          <p className={`${styles.userSubText} mt-2 text-white-100`}>
